...
def generate_triangle_pattern(number_of_vertices_labels):   # 3 nodes
...
def generate_hinge_pattern(number_of_vertices_labels):  # 3 nodes
...
def generate_adjacent_edge_triangles_pattern(number_of_vertices_labels):    # 4 nodes
...
def generate_adjacent_node_triangles_pattern(number_of_vertices_labels):    # 5 nodes
...
def generate_triangle_and_edge_pattern(number_of_vertices_labels):    # 4 nodes
...
# generate_triangle_and_edge_pattern(6)

#
# label = generate_labels_new(6,8)    # number_of_items, number_of_labels
# print(label)
