...
def label_list(number_of_vertices_labels,repeat):
    ...
    combinations = product(numbers, repeat=4)
...
for number_of_vertices_labels in number_of_vertices_labels_list:
    ...
    for i in range(repeat):
        ...
        pattern = generate_adjacent_edge_triangles_pattern(labels)
        pattern_name = "P_adjedge_NL"+str(number_of_vertices_labels)+"_"+str(i)+".gml"
        pattern_path = "/mnt/pixstor/data/yykk3/scmotif/data/large_pattern_adjedge/patterns/"
