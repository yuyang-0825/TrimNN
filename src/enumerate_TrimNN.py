...
if __name__ == "__main__":
    ...
    # result_path
    result_triangle = 'result/enumerate_triangle.csv'
    result_4order_one = 'result/enumerate_4order_one.csv'
    result_4order_two = 'result/enumerate_4order_two.csv'

    enumerate_triangle(graph_dir, model_path, result_triangle, labelnum, k)
